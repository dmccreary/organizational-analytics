---
title: ONA Timeline
description: An interactive timeline tracing the history of Organizational Network Analysis from Moreno's sociograms in 1934 to AI-powered org-graph digital twins in 2023.
image: /sims/ona-timeline/ona-timeline.png
og:image: /sims/ona-timeline/ona-timeline.png
quality_score: 72
---
...
- **Zoom** using the + / &minus; buttons (scroll wheel works in fullscreen mode)
...
1. [Moreno, J.L. - Who Shall Survive? (1934)](https://en.wikipedia.org/wiki/Jacob_L._Moreno) - Wikipedia - Foundation of sociometry and sociograms
2. [Granovetter, M. - The Strength of Weak Ties (1973)](https://en.wikipedia.org/wiki/Mark_Granovetter) - Wikipedia - Seminal paper on weak tie theory in social networks
3. [Burt, R. - Structural Holes (1992)](https://en.wikipedia.org/wiki/Structural_holes) - Wikipedia - Theory of brokerage advantages in networks
4. [Cross, R. & Parker, A. - The Hidden Power of Social Networks (2004)](https://en.wikipedia.org/wiki/Organizational_network_analysis) - Wikipedia - Operationalizing ONA for management practice
5. [vis-timeline Documentation](https://visjs.github.io/vis-timeline/docs/timeline/) - vis.js - JavaScript library used to render this timeline
